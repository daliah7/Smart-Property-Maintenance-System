...
def seed_demo_data() -> None:
    with SessionLocal() as session:
        ...
        tech_solar      = TechnicianModel(name="Valentina Russo",    expertise="Solar Photovoltaik Solaranlage Solarpanel Energie Strom")
        ...
        tech_storen     = TechnicianModel(name="Sofia Delgado",     expertise="Storen Jalousie Rolladen Sonnenschutz Markise Beschattung")

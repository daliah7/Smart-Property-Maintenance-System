...
const DEMO_TICKETS: Ticket[] = [
  ...
  { id: 18, title: "Spielplatz-Rutsche locker",             description: "Befestigung der Rutsche muss geprüft werden.", unit_id: 11, tenant_id: 11, technician_id: 4,  status: "RESOLVED",    priority: "LOW",    created_at: dAgo(45),  updated_at: dAgo(43)  },
  { id: 20, title: "Rohrbruch Badezimmer — Luzern",        description: "Wasserrohr unter Waschbecken gebrochen.", unit_id: 4,  tenant_id: 4,  technician_id: 2,  status: "RESOLVED",    priority: "HIGH",   created_at: dAgo(55),  updated_at: dAgo(53)  },
  { id: 21, title: "Heizungsausfall — Wohnzimmer Genf",    description: "Heizung ausgefallen, Aussentemperatur -3°C.", unit_id: 14, tenant_id: 14, technician_id: 2,  status: "RESOLVED",    priority: "HIGH",   created_at: dAgo(75),  updated_at: dAgo(72)  },
  { id: 22, title: "Lüftung defekt — Lugano",              description: "Lüftungsanlage macht laute Geräusche.", unit_id: 7,  tenant_id: 7,  technician_id: 5,  status: "RESOLVED",    priority: "MEDIUM", created_at: dAgo(90),  updated_at: dAgo(87)  },
  { id: 23, title: "Aufzugswartung Zürich",                description: "Jährliche Inspektion Aufzug Zürichberg.", unit_id: 9,  tenant_id: 9,  technician_id: 8,  status: "RESOLVED",    priority: "LOW",    created_at: dAgo(110), updated_at: dAgo(109) },
  { id: 24, title: "Solaranlage Reinigung",                description: "Photovoltaik-Panel verschmutzt, Leistung reduziert.", unit_id: 6,  tenant_id: 6,  technician_id: 9,  status: "RESOLVED", priority: "LOW",    created_at: dAgo(120), updated_at: dAgo(119) },
  { id: 25, title: "Türschloss Haupteingang — Bern",       description: "Schloss klemmt nach Vandalismus.", unit_id: 1,  tenant_id: 1,  technician_id: 3,  status: "RESOLVED",    priority: "HIGH",   created_at: dAgo(135), updated_at: dAgo(133) },
  { id: 26, title: "Dachrinne Landmark — verstopft",       description: "Dachrinne vollständig verstopft.", unit_id: 3,  tenant_id: 3,  technician_id: 6,  status: "RESOLVED",    priority: "MEDIUM", created_at: dAgo(150), updated_at: dAgo(148) },
  { id: 27, title: "Bodenbelag Schaden Lausanne",          description: "Parkett in Wohnzimmer aufgequollen.", unit_id: 17, tenant_id: 17, technician_id: 11, status: "RESOLVED",   priority: "MEDIUM", created_at: dAgo(160), updated_at: dAgo(157) },
  { id: 28, title: "Garagentor defekt Nidwalden",          description: "Elektrischer Antrieb Garagentor ausgefallen.", unit_id: 12, tenant_id: 12, technician_id: 19, status: "RESOLVED", priority: "MEDIUM", created_at: dAgo(170), updated_at: dAgo(168) },
  // ── CLOSED ──
  ...
  { id: 29, title: "Fassadenriss Riverside Campus",        description: "Riss in Fassade nach Frost.", unit_id: 27, tenant_id: 27, technician_id: 17, status: "CLOSED",      priority: "MEDIUM", created_at: dAgo(95),  updated_at: dAgo(88)  },
  { id: 30, title: "Brandmeldertest — Zürichberg",         description: "Jährliche Brandmelderprüfung.", unit_id: 10, tenant_id: 10, technician_id: 13, status: "CLOSED",      priority: "LOW",    created_at: dAgo(130), updated_at: dAgo(129) },
  { id: 31, title: "Smarthome Installation — Genf",        description: "WLAN-Thermostat Installation.", unit_id: 15, tenant_id: 15, technician_id: 12, status: "CLOSED",      priority: "LOW",    created_at: dAgo(155), updated_at: dAgo(154) },
  { id: 32, title: "Reinigung Treppenhaus — Lausanne",     description: "Grossreinigung nach Wasserschaden.", unit_id: 18, tenant_id: 18, technician_id: 20, status: "CLOSED",     priority: "LOW",    created_at: dAgo(175), updated_at: dAgo(174) },
  { id: 33, title: "Mauerwerk Keller — Risse",             description: "Risse im Kellerboden nach Setzung.", unit_id: 8,  tenant_id: 8,  technician_id: 17, status: "CLOSED",      priority: "HIGH",   created_at: dAgo(185), updated_at: dAgo(181) },
];
